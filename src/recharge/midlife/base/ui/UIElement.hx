...
class UIElement extends Node {
  ...
  static var uiPlane:Mesh = new Plane();
  ...
  public function new(name:String = "UIElement", ?params:Dynamic) {
    ...
    if (params != null) {
      ...
      _dimensions = params.dimensions == null ? vec2(100,
        100) : params.dimensions;
      _offset = params.offset == null ? vec2(0, 0) : params.offset;
    } else {
      _anchor = TOP_LEFT;
      _dimensions = vec2(100, 100);
      _offset = vec2(0, 0);
    }
  }
  ...
  **/
  public function getPosition():Vec2 {
    ...
    var containerSize:Vec2 = Game.getInstance().dimensions;
